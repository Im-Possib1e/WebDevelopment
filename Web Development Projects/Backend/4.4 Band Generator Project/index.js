...
app.get("/", (req, res) => {
  res.render('index.ejs', { cy:currentYear });
  //Step 1 - Make the get route work and render the index.ejs file.  --> done
});
...
app.post("/submit", (req, res) => {
  ...
  const adjPick = adj[Math.floor(Math.random() * adj.length)];
  const nounPick = noun[Math.floor(Math.random() * noun.length)];

  //2. Send the index.ejs as a response and add the adjective and noun to the res.render
  res.render('index.ejs', { cy:currentYear, adjective:adjPick, noun: nounPick  });
